# studypods..2.0
S.No.-1 Date-28/07/2021
File name-Application Form
Today's task-To create an application form for job Problems-i had problems to add all the country categories selection in one attribute. 
Solutions-i searched on google ,and from MDN Refrence i understood the select attribute and copied the code of all the county categories from option attribute and pasted it to 
my code.
